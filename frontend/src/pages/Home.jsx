...
export default function Home() {
  ...
  const [smoothMouse, setSmoothMouse] = useState({ x: -999, y: -999 })
  ...
  // Lerp the glow position for smoothness
  useEffect(() => {
  ...
  return (
    <div className="bg-[#050505] min-h-screen text-slate-300 font-sans selection:bg-emerald-500/30 relative overflow-hidden cursor-none">
      ...
      <div
        className="pointer-events-none fixed z-10 transition-none"
        style={{
          left: smoothMouse.x,
          top: smoothMouse.y,
      ...
      {/* Inner tighter glow — follows closer */}
      <div
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[90vh] pt-20 pb-12">
          ...
          <div className="flex flex-col items-start text-left z-20">
            ...
            <div className="flex flex-wrap items-center gap-5 animate-in slide-in-from-bottom-8 fade-in duration-1000 delay-500 fill-mode-both">
              ...
              >
                <div className="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/40 to-transparent -translate-x-full group-hover:animate-[shine_1.5s_infinite]" />
          ...
          <div className="hidden lg:block relative animate-in slide-in-from-right-12 fade-in duration-1000 delay-700 fill-mode-both">
            <div className="animate-[float_6s_ease-in-out_infinite]">
              <div className="absolute -inset-1 bg-gradient-to-tr from-emerald-500/20 to-cyan-500/20 rounded-2xl blur-2xl opacity-50 transition duration-1000" />
              <div className="relative bg-[#0d0d0d]/90 backdrop-blur-xl border border-slate-800 rounded-2xl shadow-2xl overflow-hidden">
                ...
                <div className="p-6 font-mono text-sm leading-loose h-[320px] overflow-y-auto text-emerald-400/90 whitespace-pre-wrap scrollbar-thin scrollbar-track-transparent scrollbar-thumb-slate-700 hover:scrollbar-thumb-emerald-500/40">
                  {terminalText}
          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-4 max-w-4xl mx-auto">
              {topics.map((topic, index) => (
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/0 to-emerald-500/5 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out z-0" />
                  <div className="flex items-center gap-6 mb-4 md:mb-0 relative z-10">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <h3 className="font-bold text-xl text-slate-200 group-hover:text-white transition-colors tracking-tight">{topic.title}</h3>
                      </div>
        ...
        <div className="py-32 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            <div className="group md:col-span-2 bg-[#0a0a0a] p-10 rounded-3xl border border-slate-800 hover:border-emerald-500/40 transition-all duration-500 overflow-hidden relative">
              <div className="absolute top-0 right-0 p-32 bg-emerald-500/5 blur-[100px] rounded-full group-hover:bg-emerald-500/10 transition-colors duration-700" />
      ...
      <style>{`
        ...
        @keyframes breathe {
          0% { transform: scale(1) translateX(-50%); opacity: 0.2; }
          100% { transform: scale(1.15) translateX(-43%); opacity: 0.5; }
        }
        @keyframes blink {
          0%, 100% { opacity: 1; }
          50% { opacity: 0; }
        ...
        .scrollbar-thumb-slate-700:hover::-webkit-scrollbar-thumb { background: rgba(16,185,129,0.4); }
      `}</style>
    </div>
  )
}